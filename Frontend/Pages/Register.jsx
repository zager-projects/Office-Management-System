...
const Register = () => {
    ...
    const [count, setCount] = useState(1001);
     ...
     const [adminID, setAdminID] = useState('AD'+ count);
     ...
     const [roleBasedAccessLevel, setRoleBasedAccessLevel] = useState('Admin');
  ...
  return (
    <>
      <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-4 text-center">Admin Registration Form</h2>
